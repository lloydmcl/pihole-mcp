...
RUN --mount=type=cache,target=/go/pkg/mod \
    ...
    -ldflags="-s -w -X github.com/lloydmcl/pihole-mcp/internal/server.Version=${VERSION}" \
...
LABEL org.opencontainers.image.source="https://github.com/lloydmcl/pihole-mcp"
